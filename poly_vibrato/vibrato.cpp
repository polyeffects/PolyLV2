...
static float vibrato_faustpower2_f(float value) {
	return (value * value);
}
static float vibrato_faustpower3_f(float value) {
	return ((value * value) * value);
}
static float vibrato_faustpower4_f(float value) {
	return (((value * value) * value) * value);
}
static float vibrato_faustpower5_f(float value) {
	return ((((value * value) * value) * value) * value);
}
static float vibrato_faustpower6_f(float value) {
	return (((((value * value) * value) * value) * value) * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS vibrato
#endif
...
class vibrato : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = std::exp((0.0f - (44.1223412f / fConst0)));
		fConst4 = (0.0166666675f * (1.0f - fConst3));
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Notch Depth (Intensity)", &fHslider0, 1.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fHslider2, "3", "");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->addHorizontalSlider("Feedback Gain", &fHslider2, 0.0f, -0.999000013f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fHslider6, "5", "");
		ui_interface->declare(&fHslider6, "style", "knob");
		ui_interface->addHorizontalSlider("Phase", &fHslider6, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Notch width", &fHslider1, 1000.0f, 10.0f, 5000.0f, 1.0f);
		ui_interface->declare(&fHslider4, "2", "");
		ui_interface->declare(&fHslider4, "scale", "log");
		ui_interface->declare(&fHslider4, "style", "knob");
		ui_interface->declare(&fHslider4, "unit", "Hz");
		ui_interface->addHorizontalSlider("Min Notch1 Freq", &fHslider4, 100.0f, 20.0f, 5000.0f, 1.0f);
		ui_interface->declare(&fHslider5, "3", "");
		ui_interface->declare(&fHslider5, "scale", "log");
		ui_interface->declare(&fHslider5, "style", "knob");
		ui_interface->declare(&fHslider5, "unit", "Hz");
		ui_interface->addHorizontalSlider("Max Notch1 Freq", &fHslider5, 800.0f, 20.0f, 10000.0f, 1.0f);
		ui_interface->declare(&fHslider3, "4", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->addHorizontalSlider("Notch Freq Ratio", &fHslider3, 1.5f, 1.10000002f, 4.0f, 0.00100000005f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(&fVslider0, "1", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 2");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("BPM", &fVslider0, 30.0f, 4.0f, 300.0f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = (0.5f * (int(float(fCheckbox0)) ? 2.0f : float(fHslider0)));
		float fSlow1 = (1.0f - fSlow0);
		float fSlow2 = std::exp((fConst1 * (0.0f - (3.14159274f * float(fHslider1)))));
		float fSlow3 = vibrato_faustpower2_f(fSlow2);
		float fSlow4 = (0.0f - (2.0f * fSlow2));
		float fSlow5 = float(fHslider2);
		float fSlow6 = float(fHslider3);
		float fSlow7 = float(fHslider4);
		float fSlow8 = (fConst2 * fSlow7);
		float fSlow9 = (0.5f * (0.0f - (fConst2 * (fSlow7 - std::max<float>(fSlow7, float(fHslider5))))));
		float fSlow10 = float(fHslider6);
		float fSlow11 = (fConst4 * float(fVslider0));
		float fSlow12 = (1.0f - fSlow10);
		float fSlow13 = vibrato_faustpower2_f(fSlow6);
		float fSlow14 = vibrato_faustpower3_f(fSlow6);
		float fSlow15 = vibrato_faustpower4_f(fSlow6);
		float fSlow16 = vibrato_faustpower5_f(fSlow6);
		float fSlow17 = vibrato_faustpower6_f(fSlow6);
		float fSlow18 = (int(float(fCheckbox1)) ? (-1.0f * fSlow0) : fSlow0);
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			iVec0[0] = 1;
			fRec9[0] = (fSlow11 + (fConst3 * fRec9[1]));
			float fTemp1 = (fConst2 * fRec9[0]);
			float fTemp2 = std::sin(fTemp1);
			float fTemp3 = std::cos(fTemp1);
			fRec7[0] = ((fRec8[1] * fTemp2) + (fRec7[1] * fTemp3));
			fRec8[0] = ((float((1 - iVec0[1])) + (fRec8[1] * fTemp3)) - (fTemp2 * fRec7[1]));
			float fTemp4 = (fSlow8 + (fSlow9 * (1.0f - ((fSlow10 * fRec8[0]) + (fSlow12 * fRec7[0])))));
			float fTemp5 = (fRec6[1] * std::cos((fSlow6 * fTemp4)));
			fRec6[0] = ((fTemp0 + (fSlow5 * fRec0[1])) - ((fSlow4 * fTemp5) + (fSlow3 * fRec6[2])));
			float fTemp6 = (fRec5[1] * std::cos((fSlow13 * fTemp4)));
			fRec5[0] = ((fSlow4 * (fTemp5 - fTemp6)) + (fRec6[2] + (fSlow3 * (fRec6[0] - fRec5[2]))));
			float fTemp7 = (fRec4[1] * std::cos((fSlow14 * fTemp4)));
			fRec4[0] = ((fSlow4 * (fTemp6 - fTemp7)) + (fRec5[2] + (fSlow3 * (fRec5[0] - fRec4[2]))));
			float fTemp8 = (fRec3[1] * std::cos((fSlow15 * fTemp4)));
			fRec3[0] = ((fSlow4 * (fTemp7 - fTemp8)) + (fRec4[2] + (fSlow3 * (fRec4[0] - fRec3[2]))));
			float fTemp9 = (fRec2[1] * std::cos((fSlow16 * fTemp4)));
			fRec2[0] = ((fSlow4 * (fTemp8 - fTemp9)) + (fRec3[2] + (fSlow3 * (fRec3[0] - fRec2[2]))));
			float fTemp10 = (fRec1[1] * std::cos((fSlow17 * fTemp4)));
			fRec1[0] = ((fSlow4 * (fTemp9 - fTemp10)) + (fRec2[2] + (fSlow3 * (fRec2[0] - fRec1[2]))));
			fRec0[0] = ((fSlow3 * fRec1[0]) + ((fSlow4 * fTemp10) + fRec1[2]));
			output0[i] = FAUSTFLOAT(((fTemp0 * fSlow1) + (fRec0[0] * fSlow18)));
			iVec0[1] = iVec0[0];
			fRec9[1] = fRec9[0];
			fRec7[1] = fRec7[0];
			fRec8[1] = fRec8[0];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/vibrato"
#endif
...
struct LV2Plugin {
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (vibrato**)calloc(ndsps, sizeof(vibrato*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "vibrato";
