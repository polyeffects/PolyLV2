...
class flanger : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::exp((0.0f - (44.1223412f / fConst0)));
		fConst3 = (1.0f - fConst2);
		fConst4 = (0.0166666675f * fConst3);
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider3 = FAUSTFLOAT(0.22f);
		fVslider4 = FAUSTFLOAT(0.0f);
		fVslider5 = FAUSTFLOAT(0.75f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider3, "midi", "ctrl 50");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider3, 0.219999999f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider1, "2", "");
		ui_interface->declare(&fVslider1, "midi", "ctrl 2");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("BPM", &fVslider1, 30.0f, 5.0f, 300.0f, 0.00999999978f);
		ui_interface->declare(&fVslider5, "3", "");
		ui_interface->declare(&fVslider5, "midi", "ctrl 3");
		ui_interface->declare(&fVslider5, "style", "knob");
		ui_interface->addVerticalSlider("Depth", &fVslider5, 0.75f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider4, "4", "");
		ui_interface->declare(&fVslider4, "midi", "ctrl 49");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->addVerticalSlider("Invert", &fVslider4, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider2, "5", "");
		ui_interface->declare(&fVslider2, "midi", "ctrl 4");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("Feedback", &fVslider2, 0.0f, -0.995000005f, 0.99000001f, 0.00100000005f);
		ui_interface->declare(&fVslider0, "6", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 54");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("Waveshape", &fVslider0, 0.0f, 0.0f, 1.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow4 = (2003.0f * float(fVslider3));
		int iSlow5 = int(float(fVslider4));
		float fSlow6 = (fConst3 * float(fVslider5));
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec1[0] = (fSlow1 + (fConst2 * fRec1[1]));
			float fTemp0 = (fRec0[1] + (fConst1 * fRec1[1]));
			fRec0[0] = (fTemp0 - std::floor(fTemp0));
			float fTemp1 = (fConst5 * fRec1[0]);
			float fTemp2 = std::sin(fTemp1);
			float fTemp3 = std::cos(fTemp1);
			fRec2[0] = ((fRec3[1] * fTemp2) + (fRec2[1] * fTemp3));
			fRec3[0] = ((float((1 - iVec0[1])) + (fRec3[1] * fTemp3)) - (fTemp2 * fRec2[1]));
			float fTemp4 = ((fSlow0 * (1.0f - std::fabs(((2.0f * fRec0[0]) + -1.0f)))) + (fSlow2 * (fRec2[0] + 1.0f)));
			float fTemp5 = float(input0[i]);
			fRec5[0] = (fSlow3 + (fConst2 * fRec5[1]));
			float fTemp6 = ((fRec5[0] * fRec4[1]) - fTemp5);
			fVec1[(IOTA & 4095)] = fTemp6;
			float fTemp7 = (fSlow4 * fTemp4);
			float fTemp8 = (fTemp7 + 44.0f);
			int iTemp9 = int(fTemp8);
			float fTemp10 = std::floor(fTemp8);
			fRec4[0] = ((fVec1[((IOTA - std::min<int>(2049, std::max<int>(0, iTemp9))) & 4095)] * (fTemp10 + (-43.0f - fTemp7))) + ((fTemp7 + (44.0f - fTemp10)) * fVec1[((IOTA - std::min<int>(2049, std::max<int>(0, (iTemp9 + 1)))) & 4095)]));
			fRec6[0] = (fSlow6 + (fConst2 * fRec6[1]));
			output0[i] = FAUSTFLOAT(((fTemp5 + (fRec4[0] * (iSlow5 ? (-1.0f * fRec6[0]) : fRec6[0]))) / (fRec6[0] + 1.0f)));
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
