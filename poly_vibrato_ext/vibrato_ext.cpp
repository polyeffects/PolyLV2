...
#ifndef  __vibrato_ext_H__
#define  __vibrato_ext_H__
...
static float vibrato_ext_faustpower2_f(float value) {
	return (value * value);
}
static float vibrato_ext_faustpower3_f(float value) {
	return ((value * value) * value);
}
static float vibrato_ext_faustpower4_f(float value) {
	return (((value * value) * value) * value);
}
static float vibrato_ext_faustpower5_f(float value) {
	return ((((value * value) * value) * value) * value);
}
static float vibrato_ext_faustpower6_f(float value) {
	return (((((value * value) * value) * value) * value) * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS vibrato_ext
#endif
...
class vibrato_ext : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("filename", "vibrato_ext.dsp");
	...
	virtual vibrato_ext* clone() {
		return new vibrato_ext();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = vibrato_ext_faustpower2_f(fSlow2);
		...
		float fSlow9 = (0.0f - (fConst2 * (fSlow7 - std::max<float>(fSlow7, float(fHslider5)))));
		float fSlow10 = vibrato_ext_faustpower2_f(fSlow6);
		float fSlow11 = vibrato_ext_faustpower3_f(fSlow6);
		float fSlow12 = vibrato_ext_faustpower4_f(fSlow6);
		float fSlow13 = vibrato_ext_faustpower5_f(fSlow6);
		float fSlow14 = vibrato_ext_faustpower6_f(fSlow6);
		float fSlow15 = (int(float(fCheckbox1)) ? (-1.0f * fSlow0) : fSlow0);
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input1[i]);
			float fTemp1 = (fSlow8 + (fSlow9 * float(input0[i])));
			float fTemp2 = (fRec6[1] * std::cos((fSlow6 * fTemp1)));
			fRec6[0] = ((fTemp0 + (fSlow5 * fRec0[1])) - ((fSlow4 * fTemp2) + (fSlow3 * fRec6[2])));
			float fTemp3 = (fRec5[1] * std::cos((fSlow10 * fTemp1)));
			fRec5[0] = ((fSlow4 * (fTemp2 - fTemp3)) + (fRec6[2] + (fSlow3 * (fRec6[0] - fRec5[2]))));
			float fTemp4 = (fRec4[1] * std::cos((fSlow11 * fTemp1)));
			fRec4[0] = ((fSlow4 * (fTemp3 - fTemp4)) + (fRec5[2] + (fSlow3 * (fRec5[0] - fRec4[2]))));
			float fTemp5 = (fRec3[1] * std::cos((fSlow12 * fTemp1)));
			fRec3[0] = ((fSlow4 * (fTemp4 - fTemp5)) + (fRec4[2] + (fSlow3 * (fRec4[0] - fRec3[2]))));
			float fTemp6 = (fRec2[1] * std::cos((fSlow13 * fTemp1)));
			fRec2[0] = ((fSlow3 * (fRec3[0] - fRec2[2])) + (fRec3[2] + (fSlow4 * (fTemp5 - fTemp6))));
			float fTemp7 = (fRec1[1] * std::cos((fSlow14 * fTemp1)));
			fRec1[0] = ((fSlow4 * (fTemp6 - fTemp7)) + (fRec2[2] + (fSlow3 * (fRec2[0] - fRec1[2]))));
			fRec0[0] = ((fSlow3 * fRec1[0]) + ((fSlow4 * fTemp7) + fRec1[2]));
			output0[i] = FAUSTFLOAT(((fTemp0 * fSlow1) + (fRec0[0] * fSlow15)));
			fRec6[2] = fRec6[1];
			fRec6[1] = fRec6[0];
			fRec5[2] = fRec5[1];
			fRec5[1] = fRec5[0];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/vibrato_ext"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      vibrato_ext* tmp_dsp = new vibrato_ext();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "vibrato_ext");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (vibrato_ext**)calloc(ndsps, sizeof(vibrato_ext*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "vibrato_ext";
