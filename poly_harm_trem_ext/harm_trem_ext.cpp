...
#ifndef  __harm_trem_ext_H__
#define  __harm_trem_ext_H__
...
static float harm_trem_ext_faustpower2_f(float value) {
	return (value * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS harm_trem_ext
#endif
...
class harm_trem_ext : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "harm_trem_ext.dsp");
	...
	virtual harm_trem_ext* clone() {
		return new harm_trem_ext();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("harm_trem_ext");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = std::tan((fConst0 * fRec2[0]));
			...
			float fTemp6 = harm_trem_ext_faustpower2_f(fTemp1);
			...
			fRec5[0] = (0.0f - (((fTemp4 * fRec5[1]) - (fTemp0 + fVec0[1])) / fTemp3));
			fRec4[0] = (fRec5[0] - (((fTemp5 * fRec4[2]) + (2.0f * (fTemp7 * fRec4[1]))) / fTemp8));
			output0[i] = FAUSTFLOAT(((((((fRec0[1] * (0.0f - (2.0f / fTemp6))) + (fRec0[0] / fTemp6)) + (fRec0[2] / fTemp6)) * (1.0f - (0.5f * (fRec3[0] * (fTemp9 + 1.0f))))) + ((fRec4[2] + (fRec4[0] + (2.0f * fRec4[1]))) * (1.0f - (0.5f * (fRec3[0] * ((1.0f - fTemp9) + 1.0f)))))) / fTemp8));
			fVec0[1] = fVec0[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/harm_trem_ext"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      harm_trem_ext* tmp_dsp = new harm_trem_ext();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "harm_trem_ext");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (harm_trem_ext**)calloc(ndsps, sizeof(harm_trem_ext*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "harm_trem_ext";
