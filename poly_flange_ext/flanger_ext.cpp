...
#ifndef  __flanger_ext_H__
#define  __flanger_ext_H__
...
class flanger_ext : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "flanger_ext.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "flanger_ext");
	...
	virtual flanger_ext* clone() {
		return new flanger_ext();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flanger_ext");
		ui_interface->declare(&fVslider1, "1", "");
		ui_interface->declare(&fVslider1, "midi", "ctrl 50");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider1, 0.219999999f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider3, "3", "");
		ui_interface->declare(&fVslider3, "midi", "ctrl 3");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->addVerticalSlider("Depth", &fVslider3, 0.75f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider2, "4", "");
		ui_interface->declare(&fVslider2, "midi", "ctrl 49");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("Invert", &fVslider2, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider0, "5", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 4");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("Feedback", &fVslider0, 0.0f, -0.995000005f, 0.99000001f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (2003.0f * float(fVslider1));
		int iSlow2 = int(float(fVslider2));
		float fSlow3 = (fConst1 * float(fVslider3));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input1[i]);
			fRec1[0] = (fSlow0 + (fConst0 * fRec1[1]));
			float fTemp1 = ((fRec1[0] * fRec0[1]) - fTemp0);
			fVec0[(IOTA & 4095)] = fTemp1;
			float fTemp2 = (fSlow1 * float(input0[i]));
			float fTemp3 = (fTemp2 + 44.0f);
			int iTemp4 = int(fTemp3);
			float fTemp5 = std::floor(fTemp3);
			fRec0[0] = ((fVec0[((IOTA - std::min<int>(2049, std::max<int>(0, iTemp4))) & 4095)] * (fTemp5 + (-43.0f - fTemp2))) + ((fTemp2 + (44.0f - fTemp5)) * fVec0[((IOTA - std::min<int>(2049, std::max<int>(0, (iTemp4 + 1)))) & 4095)]));
			fRec2[0] = (fSlow3 + (fConst0 * fRec2[1]));
			output0[i] = FAUSTFLOAT(((fTemp0 + (fRec0[0] * (iSlow2 ? (-1.0f * fRec2[0]) : fRec2[0]))) / (fRec2[0] + 1.0f)));
			fRec1[1] = fRec1[0];
			IOTA = (IOTA + 1);
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/flanger_ext"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      flanger_ext* tmp_dsp = new flanger_ext();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "flanger_ext");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (flanger_ext**)calloc(ndsps, sizeof(flanger_ext*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "flanger_ext";
