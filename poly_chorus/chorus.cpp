...
class chorusSIG0 {
  ...
  public:
	...
	void instanceInitchorusSIG0(int sample_rate) {
		for (int l4 = 0; (l4 < 2); l4 = (l4 + 1)) {
			iRec3[l4] = 0;
		}
	}
	
	void fillchorusSIG0(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec3[0] = (iRec3[1] + 1);
			table[i] = std::cos((9.58738019e-05f * float((iRec3[0] + -1))));
			iRec3[1] = iRec3[0];
		}
	}
...
static chorusSIG0* newchorusSIG0() { return (chorusSIG0*)new chorusSIG0(); }
static void deletechorusSIG0(chorusSIG0* dsp) { delete dsp; }
...
class chorusSIG1 {
  ...
  public:
	...
	int getNumInputschorusSIG1() {
		return 0;
	}
	int getNumOutputschorusSIG1() {
		return 1;
	}
	int getInputRatechorusSIG1(int channel) {
		int rate;
		switch ((channel)) {
			default: {
				rate = -1;
	...
	int getOutputRatechorusSIG1(int channel) {
		int rate;
		switch ((channel)) {
			case 0: {
				rate = 0;
	...
	void instanceInitchorusSIG1(int sample_rate) {
		for (int l7 = 0; (l7 < 2); l7 = (l7 + 1)) {
			iRec6[l7] = 0;
		}
	}
	
	void fillchorusSIG1(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec6[0] = (iRec6[1] + 1);
...
static chorusSIG1* newchorusSIG1() { return (chorusSIG1*)new chorusSIG1(); }
static void deletechorusSIG1(chorusSIG1* dsp) { delete dsp; }

static float ftbl0chorusSIG0[65536];
static float ftbl1chorusSIG1[65536];
...
class chorus : public dsp {
 ...
 public:
	...
	static void classInit(int sample_rate) {
		...
		chorusSIG1* sig1 = newchorusSIG1();
		sig1->instanceInitchorusSIG1(sample_rate);
		sig1->fillchorusSIG1(65536, ftbl1chorusSIG1);
		deletechorusSIG0(sig0);
		deletechorusSIG1(sig1);
	}
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst4 = (0.0166666675f * fConst2);
		fConst5 = (1.0f / fConst0);
		fConst6 = (0.142857149f / fConst0);
		fConst7 = (0.5f / fConst0);
		fConst8 = (0.25f / fConst0);
		fConst9 = (0.166666672f / fConst0);
		fConst10 = (0.125f / fConst0);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("BPM", &fVslider4, 30.0f, 10.0100002f, 420.0f, 9.99999975e-05f);
		ui_interface->declare(&fVslider0, "2", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 105");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp4 = std::min<float>(8192.0f, ((0.375f * fRec1[0]) + (fRec2[0] * ftbl0chorusSIG0[int((65536.0f * fRec4[0]))])));
			int iTemp5 = int(fTemp4);
			float fTemp6 = std::floor(fTemp4);
			float fTemp7 = (fRec7[1] + (fConst5 * fRec5[0]));
			fRec7[0] = (fTemp7 - std::floor(fTemp7));
			float fTemp8 = std::min<float>(8192.0f, ((0.125f * fRec1[0]) + (fRec2[0] * ftbl1chorusSIG1[int((65536.0f * fRec7[0]))])));
			float fTemp9 = std::floor(fTemp8);
			int iTemp10 = int(fTemp8);
			float fTemp11 = (fTemp1 * (1.0f - fRec0[0]));
			float fTemp12 = (fRec8[1] + (fConst6 * fRec5[0]));
			fRec8[0] = (fTemp12 - std::floor(fTemp12));
			float fTemp13 = std::min<float>(8192.0f, ((0.875f * fRec1[0]) + (fRec2[0] * (0.0f - ftbl0chorusSIG0[int((65536.0f * fRec8[0]))]))));
			int iTemp14 = int(fTemp13);
			float fTemp15 = std::floor(fTemp13);
			output0[i] = FAUSTFLOAT((iSlow0 ? fTemp0 : (((0.707106769f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp5))) & 16383)] * (fTemp6 + (1.0f - fTemp4))) + ((fTemp4 - fTemp6) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp5 + 1)))) & 16383)]))) + (((fTemp8 - fTemp9) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp10 + 1)))) & 16383)]) + (fTemp11 + (fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp10))) & 16383)] * (fTemp9 + (1.0f - fTemp8)))))) - (0.707106769f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp14))) & 16383)] * (fTemp15 + (1.0f - fTemp13))) + ((fTemp13 - fTemp15) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp14 + 1)))) & 16383)]))))));
			float fTemp16 = (fRec9[1] + (fConst7 * fRec5[0]));
			fRec9[0] = (fTemp16 - std::floor(fTemp16));
			int iTemp17 = int((65536.0f * fRec9[0]));
			float fTemp18 = std::min<float>(8192.0f, ((0.25f * fRec1[0]) + (fRec2[0] * ((0.707106769f * ftbl1chorusSIG1[iTemp17]) + (0.707106769f * ftbl0chorusSIG0[iTemp17])))));
			int iTemp19 = int(fTemp18);
			float fTemp20 = std::floor(fTemp18);
			float fTemp21 = (fRec10[1] + (fConst8 * fRec5[0]));
			fRec10[0] = (fTemp21 - std::floor(fTemp21));
			int iTemp22 = int((65536.0f * fRec10[0]));
			float fTemp23 = std::min<float>(8192.0f, ((0.5f * fRec1[0]) + (fRec2[0] * ((0.707106769f * ftbl0chorusSIG0[iTemp22]) - (0.707106769f * ftbl1chorusSIG1[iTemp22])))));
			int iTemp24 = int(fTemp23);
			float fTemp25 = std::floor(fTemp23);
			float fTemp26 = (fRec11[1] + (fConst9 * fRec5[0]));
			fRec11[0] = (fTemp26 - std::floor(fTemp26));
			int iTemp27 = int((65536.0f * fRec11[0]));
			float fTemp28 = std::min<float>(8192.0f, ((0.75f * fRec1[0]) + (fRec2[0] * (0.0f - ((0.707106769f * ftbl1chorusSIG1[iTemp27]) + (0.707106769f * ftbl0chorusSIG0[iTemp27]))))));
			int iTemp29 = int(fTemp28);
			float fTemp30 = std::floor(fTemp28);
			float fTemp31 = (fRec12[1] + (fConst10 * fRec5[0]));
			fRec12[0] = (fTemp31 - std::floor(fTemp31));
			int iTemp32 = int((65536.0f * fRec12[0]));
			float fTemp33 = std::min<float>(8192.0f, (fRec1[0] + (fRec2[0] * ((0.707106769f * ftbl1chorusSIG1[iTemp32]) - (0.707106769f * ftbl0chorusSIG0[iTemp32])))));
			int iTemp34 = int(fTemp33);
			float fTemp35 = std::floor(fTemp33);
			output1[i] = FAUSTFLOAT((iSlow0 ? fTemp0 : (fTemp11 - ((((0.382683426f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp19))) & 16383)] * (fTemp20 + (1.0f - fTemp18))) + ((fTemp18 - fTemp20) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp19 + 1)))) & 16383)]))) + (0.923879504f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp24))) & 16383)] * (fTemp25 + (1.0f - fTemp23))) + ((fTemp23 - fTemp25) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp24 + 1)))) & 16383)])))) + (0.923879504f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp29))) & 16383)] * (fTemp30 + (1.0f - fTemp28))) + ((fTemp28 - fTemp30) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp29 + 1)))) & 16383)])))) + (0.382683426f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp34))) & 16383)] * (fTemp35 + (1.0f - fTemp33))) + ((fTemp33 - fTemp35) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp34 + 1)))) & 16383)])))))));
			fRec0[1] = fRec0[0];
			IOTA = (IOTA + 1);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/chorus"
#endif
...
struct LV2Plugin {
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (chorus**)calloc(ndsps, sizeof(chorus*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "chorus";
