...
#ifndef  __chorus_ext_H__
#define  __chorus_ext_H__
...
class chorus_ext : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "chorus_ext.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "chorus_ext");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst0 = std::exp((0.0f - (44.1223412f / std::min<float>(192000.0f, std::max<float>(1.0f, float(fSampleRate))))));
	...
	virtual chorus_ext* clone() {
		return new chorus_ext();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("chorus_ext");
		ui_interface->declare(&fVslider1, "0", "");
		ui_interface->declare(&fVslider1, "midi", "ctrl 4");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider1, 0.5f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider0, "4", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 3");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("Depth", &fVslider0, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider2, "6", "");
		ui_interface->declare(&fVslider2, "midi", "ctrl 58");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("Deviation", &fVslider2, 0.5f, 0.0f, 1.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (8.19200039f * float(fVslider1));
		float fSlow2 = (8.33333324e-05f * float(fVslider2));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec2[0] = ((0.999000013f * fRec2[1]) + (fSlow2 * fRec1[0]));
			float fTemp3 = std::min<float>(8192.0f, ((0.5f * fRec1[0]) + (std::sin((fTemp2 + 2.09439516f)) * fRec2[0])));
			int iTemp4 = int(fTemp3);
			float fTemp5 = std::floor(fTemp3);
			float fTemp6 = std::min<float>(8192.0f, ((0.166666672f * fRec1[0]) + (fRec2[0] * std::sin(fTemp2))));
			float fTemp7 = std::floor(fTemp6);
			int iTemp8 = int(fTemp6);
			float fTemp9 = (fTemp0 * (1.0f - fRec0[0]));
			float fTemp10 = std::min<float>(8192.0f, ((0.833333313f * fRec1[0]) + (std::sin((fTemp2 + 4.18879032f)) * fRec2[0])));
			int iTemp11 = int(fTemp10);
			float fTemp12 = std::floor(fTemp10);
			output0[i] = FAUSTFLOAT((((0.5f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp4))) & 16383)] * (fTemp5 + (1.0f - fTemp3))) + ((fTemp3 - fTemp5) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp4 + 1)))) & 16383)]))) + (((fTemp6 - fTemp7) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp8 + 1)))) & 16383)]) + (fTemp9 + (fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp8))) & 16383)] * (fTemp7 + (1.0f - fTemp6)))))) - (0.5f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp11))) & 16383)] * (fTemp12 + (1.0f - fTemp10))) + ((fTemp10 - fTemp12) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp11 + 1)))) & 16383)])))));
			float fTemp13 = std::min<float>(8192.0f, ((0.666666687f * fRec1[0]) + (std::sin((fTemp2 + 3.14159274f)) * fRec2[0])));
			float fTemp14 = std::floor(fTemp13);
			int iTemp15 = int(fTemp13);
			float fTemp16 = std::min<float>(8192.0f, ((0.333333343f * fRec1[0]) + (std::sin((fTemp2 + 1.04719758f)) * fRec2[0])));
			int iTemp17 = int(fTemp16);
			float fTemp18 = std::floor(fTemp16);
			float fTemp19 = std::min<float>(8192.0f, (fRec1[0] + (std::sin((fTemp2 + 5.23598766f)) * fRec2[0])));
			int iTemp20 = int(fTemp19);
			float fTemp21 = std::floor(fTemp19);
			output1[i] = FAUSTFLOAT((fTemp9 - ((((fTemp13 - fTemp14) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp15 + 1)))) & 16383)]) + ((0.5f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp17))) & 16383)] * (fTemp18 + (1.0f - fTemp16))) + ((fTemp16 - fTemp18) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp17 + 1)))) & 16383)]))) + (fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp15))) & 16383)] * (fTemp14 + (1.0f - fTemp13))))) + (0.5f * ((fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, iTemp20))) & 16383)] * (fTemp21 + (1.0f - fTemp19))) + ((fTemp19 - fTemp21) * fVec0[((IOTA - std::min<int>(8193, std::max<int>(0, (iTemp20 + 1)))) & 16383)]))))));
			fRec0[1] = fRec0[0];
			IOTA = (IOTA + 1);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/chorus_ext"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      chorus_ext* tmp_dsp = new chorus_ext();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "chorus_ext");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (chorus_ext**)calloc(ndsps, sizeof(chorus_ext*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "chorus_ext";
