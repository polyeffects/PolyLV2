/* ------------------------------------------------------------
name: "bitcrushed_delay"
Code generated with Faust 2.20.2 (https://faust.grame.fr)
Compilation options: -lang cpp -scal -ftz 0
------------------------------------------------------------ */

#ifndef  __bitcrushed_delay_H__
#define  __bitcrushed_delay_H__
...
static float bitcrushed_delay_faustpower2_f(float value) {
	return (value * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS bitcrushed_delay
#endif
...
class bitcrushed_delay : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "bitcrushed_delay.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "bitcrushed_delay");
	...
	virtual bitcrushed_delay* clone() {
		return new bitcrushed_delay();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("bitcrushed_delay");
		ui_interface->addHorizontalSlider("NBITS", &fHslider0, 8.0f, 0.0f, 16.0f, 1.0f);
		...
		ui_interface->addVerticalSlider("Delay", &fVslider5, 0.5f, 0.00100000005f, 64.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (std::pow(2.0f, float(fHslider0)) + -1.0f);
		float fSlow2 = (1.0f / fSlow1);
		float fSlow3 = float(fastpow2(float((0.0f - (5.99794197f * float(fVslider1))))));
		float fSlow4 = (1.0f - fSlow3);
		int iSlow5 = int((1.0f - float(fVslider2)));
		float fSlow6 = float(fVslider3);
		float fSlow7 = float(fVslider4);
		float fSlow8 = (((0.144717798f * fSlow7) > 0.0f) ? std::exp((0.0f - (fConst3 / fSlow7))) : 0.0f);
		float fSlow9 = (fConst4 * (float(fVslider5) / float(fVslider6)));
		float fSlow10 = (1.0f - fSlow8);
		float fSlow11 = (fSlow9 * fSlow10);
		float fSlow12 = (float(fVslider7) * fSlow10);
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (fSlow0 + (fConst1 * fRec0[1]));
			fRec3[(IOTA & 2097151)] = ((fSlow4 * fRec3[((IOTA - 1) & 2097151)]) + (fSlow3 * ((iSlow5 ? 0.0f : float(input0[i])) + (fSlow6 * fRec1[1]))));
			fRec4[0] = ((fRec4[1] * fSlow8) + fSlow11);
			int iTemp0 = int(fRec4[0]);
			float fTemp1 = std::floor(fRec4[0]);
			float fTemp2 = ((fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, iTemp0))) & 2097151)] * (fTemp1 + (1.0f - fRec4[0]))) + ((fRec4[0] - fTemp1) * fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, (iTemp0 + 1)))) & 2097151)]));
			fRec1[0] = (fSlow2 * (std::floor(((fSlow1 * std::fabs(fTemp2)) + 0.5f)) * (float((2 * (fTemp2 > 0.0f))) + -1.0f)));
			fRec6[0] = ((fSlow8 * fRec6[1]) + fSlow12);
			fRec7[0] = (fSlow8 * fRec7[1]);
			fRec5[0] = ((fSlow8 * fRec5[1]) + (fSlow9 * (fSlow10 * ((fRec6[0] + bitcrushed_delay_faustpower2_f(fRec7[0])) + 1.0f))));
			int iTemp3 = int(fRec5[0]);
			float fTemp4 = std::floor(fRec5[0]);
			float fTemp5 = ((fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, iTemp3))) & 2097151)] * (fTemp4 + (1.0f - fRec5[0]))) + ((fRec5[0] - fTemp4) * fRec3[((IOTA - std::min<int>(1048577, std::max<int>(0, (iTemp3 + 1)))) & 2097151)]));
			float fRec2 = (fSlow2 * (std::floor(((fSlow1 * std::fabs(fTemp5)) + 0.5f)) * (float((2 * (fTemp5 > 0.0f))) + -1.0f)));
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/bitcrushed_delay"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      bitcrushed_delay* tmp_dsp = new bitcrushed_delay();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "bitcrushed_delay");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (bitcrushed_delay**)calloc(ndsps, sizeof(bitcrushed_delay*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "bitcrushed_delay";
