...
#ifndef  __harm_trem_H__
#define  __harm_trem_H__
...
class harm_tremSIG0 {
  ...
  public:
	...
	int getNumInputsharm_tremSIG0() {
		return 0;
	}
	int getNumOutputsharm_tremSIG0() {
		return 1;
	}
	int getInputRateharm_tremSIG0(int channel) {
		int rate;
		switch ((channel)) {
			default: {
				rate = -1;
	...
	int getOutputRateharm_tremSIG0(int channel) {
		int rate;
		switch ((channel)) {
			case 0: {
				rate = 0;
	...
	void instanceInitharm_tremSIG0(int sample_rate) {
		for (int l5 = 0; (l5 < 2); l5 = (l5 + 1)) {
			iRec4[l5] = 0;
		}
	}
	
	void fillharm_tremSIG0(int count, float* table) {
...
static harm_tremSIG0* newharm_tremSIG0() { return (harm_tremSIG0*)new harm_tremSIG0(); }
static void deleteharm_tremSIG0(harm_tremSIG0* dsp) { delete dsp; }

static float harm_trem_faustpower2_f(float value) {
	return (value * value);
}
static float ftbl0harm_tremSIG0[65536];

#ifndef FAUSTCLASS 
#define FAUSTCLASS harm_trem
#endif
...
class harm_trem : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "harm_trem.dsp");
	...
	static void classInit(int sample_rate) {
		harm_tremSIG0* sig0 = newharm_tremSIG0();
		sig0->instanceInitharm_tremSIG0(sample_rate);
		sig0->fillharm_tremSIG0(65536, ftbl0harm_tremSIG0);
		deleteharm_tremSIG0(sig0);
	}
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = (0.0166666675f / fConst0);
	}
	
	virtual void instanceResetUserInterface() {
		fVslider0 = FAUSTFLOAT(800.0f);
	...
	virtual harm_trem* clone() {
		return new harm_trem();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("harm_trem");
		ui_interface->declare(&fVslider1, "0", "");
		ui_interface->declare(&fVslider1, "midi", "ctrl 63");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("BPM", &fVslider1, 120.0f, 15.0f, 300.0f, 0.100000001f);
		ui_interface->declare(&fVslider0, "1", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 64");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("CrossoverFreq", &fVslider0, 800.0f, 20.0f, 10000.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = std::tan((fConst1 * fRec2[0]));
			float fTemp2 = (1.0f / fTemp1);
			float fTemp3 = (fTemp2 + 1.0f);
			float fTemp4 = (1.0f - fTemp2);
			fRec1[0] = ((fVec0[1] * (0.0f - (1.0f / (fTemp1 * fTemp3)))) - (((fRec1[1] * fTemp4) - (fTemp0 / fTemp1)) / fTemp3));
			float fTemp5 = (((fTemp2 + -1.0f) / fTemp1) + 1.0f);
			float fTemp6 = harm_trem_faustpower2_f(fTemp1);
			float fTemp7 = (1.0f - (1.0f / fTemp6));
			float fTemp8 = (((fTemp2 + 1.0f) / fTemp1) + 1.0f);
			fRec0[0] = (fRec1[0] - (((fRec0[2] * fTemp5) + (2.0f * (fRec0[1] * fTemp7))) / fTemp8));
			fRec3[0] = (fSlow1 + (0.999000013f * fRec3[1]));
			fRec6[0] = (fSlow2 + (0.999000013f * fRec6[1]));
			float fTemp9 = (fRec5[1] + (fConst2 * fRec6[0]));
			fRec5[0] = (fTemp9 - std::floor(fTemp9));
			float fTemp10 = ftbl0harm_tremSIG0[int((65536.0f * fRec5[0]))];
			fRec8[0] = (0.0f - (((fTemp4 * fRec8[1]) - (fTemp0 + fVec0[1])) / fTemp3));
			fRec7[0] = (fRec8[0] - (((fTemp5 * fRec7[2]) + (2.0f * (fTemp7 * fRec7[1]))) / fTemp8));
			output0[i] = FAUSTFLOAT(((((((fRec0[1] * (0.0f - (2.0f / fTemp6))) + (fRec0[0] / fTemp6)) + (fRec0[2] / fTemp6)) * (1.0f - (0.5f * (fRec3[0] * (fTemp10 + 1.0f))))) + ((fRec7[2] + (fRec7[0] + (2.0f * fRec7[1]))) * (1.0f - (0.5f * (fRec3[0] * ((1.0f - fTemp10) + 1.0f)))))) / fTemp8));
			fVec0[1] = fVec0[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/harm_trem"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      harm_trem* tmp_dsp = new harm_trem();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "harm_trem");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (harm_trem**)calloc(ndsps, sizeof(harm_trem*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "harm_trem";
